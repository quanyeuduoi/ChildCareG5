                    ...
                    <div class="container bootstrap snippets bootdey">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 personal-info">
                                ...
                                <h3>Personal info</h3>
                                <form class="form-horizontal" action="userDetail?email=${cus.getEmail()}" method ="post" role="form">
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Full name:</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name ="fullName" pattern="[A-Za-z]+" value="${cus.getFullName()}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Address</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name ="address" value="${cus.getAddress()}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="phone" pattern="[0-9]+" oninvalid="this.setCustomValidity('Vui lòng nhập số điện thoại hợp lệ.')" value="${cus.getPhoneNumber()}">
                                        </div>
                                    </div>
