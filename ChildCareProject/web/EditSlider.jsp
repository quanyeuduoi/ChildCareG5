...
<html lang="en">
    <head>
        ...
        <title>ChildCare G5 | Edit Slider</title>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                ...
                                <a class="navbar-brand" href="#pablo">Edit Slider</a>
                            </div>
                                ...
                                <div class="card-body">
                                    <form action="EditSlider" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sliderID" class="form-control" name="sID" value="${sliderInfo.getSliderID()}" disabled >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="${sliderInfo.getImageSlider()}" type="file" id="file" name="file" onchange="previewImage(this)">
                                            <button type="button" onclick="document.getElementById('file').click()">Upload</button>
                                            <p id="fileNameDisplay"></p>
                                        </div>
                                        <p>Old image </p>
                                        <image src="Image/SliderImage/${sliderInfo.getImageSlider()}" style="max-width: 100%; max-height: 200px;">
                                        <p>New image </p>
