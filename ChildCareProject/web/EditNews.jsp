...
<html lang="en">
    <head>
        ...
        <title>G2 Banking | Edit News</title>
    ...
    <body class="user-profile">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                ...
                                <a class="navbar-brand" href="#pablo">Edit News</a>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a href="ManagerNews" class="btn btn-primary btn-sm float-right" style="margin-top: -40px;">Back</a>
                                    </div>
                                ...
                                <div class="card-body">
                                    <form action="EditNews" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="Nid" name="Nid" value="${detailNew.newID}" readonly >
                                        </div>
                                        <div class="form-group">
                                            <label for="title">Title:</label>
                                            <input type="text" class="form-control" id="title" name="title" value="${detailNew.title}" required>
                                        </div>
                                        <div class="form-group" >
                                            <label for="title">Modified By</label>
                                            <input type="text" class="form-control" id="modifiedBy" name="modifiedBy" value="${employ.eName}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="date">Date:</label>
                                            <input type="text" class="form-control" id="modifiedOn" name="modifiedOn" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Content:</label>
                                            <textarea id="description" name="description" rows="20" cols="150" required>${detailNew.description}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="image">Image:</label>
                                            <input type="file" id="image" name="image" >
                                            <button type="button" onclick="document.getElementById('image').click()">Upload</button>
                                            <p id="fileNameDisplay">${detailNew.image}</p>
                                        </div>
                                        <div class="form-group">
        ...
        <script>
            function updateDateTime() {
                ...
                var dateField = document.getElementById("modifiedOn");
                var year = currentDate.getFullYear();
                var month = (currentDate.getMonth() + 1).toString().padStart(2, '0'); // Thêm 0 phía trước nếu tháng chỉ có 1 chữ số
                var day = currentDate.getDate().toString().padStart(2, '0');
                var hours = currentDate.getHours().toString().padStart(2, '0');
                var minutes = currentDate.getMinutes().toString().padStart(2, '0');
                var dateTimeString = hours + ':' + minutes + ' ' + day + '/' + month + '/' + year;
                dateField.value = dateTimeString;
            }
            updateDateTime();
